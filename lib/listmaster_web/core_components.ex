defmodule ListmasterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ListmasterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ListmasterWeb.Gettext, "errors", msg, opts)
    end
  end
